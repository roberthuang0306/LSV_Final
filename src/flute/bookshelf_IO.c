...
void readAuxFile(char benchmarkPath[], char auxFile[]) 
{
    ...
    nodesFile = (char*)cvector(0, BUFFERSIZE);
    netsFile = (char*)cvector(0, BUFFERSIZE);
    wtsFile = (char*)cvector(0, BUFFERSIZE);
    sclFile = (char*)cvector(0, BUFFERSIZE);
    plFile = (char*)cvector(0, BUFFERSIZE);
    benchmarkName = (char*)cvector(0, BUFFERSIZE);
